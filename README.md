...
2.如果您不选用公有的RTMP视频推流格式，或您自己选择了其他第三方更加快速的私有视频协议，您也可以购买我们的产品，然后选择不安装android-push.apk。
<br>此时您必须:开发自己的推流apk。 在您的apk中，您将需要
* 根据网络娃娃机主板发来的命令处理数据并转发给应用服务器。该文档对应document.docx.后续我们会将其更新到本github的wiki页面
...
* [**document.docx**]	网络娃娃机相关的命令文档。 例如，按下左右移动操作是发什么命令？下抓是什么命令？报故障时是什么命令？方便您的程序员在不使用以上范例的时候，自行发送命令使娃娃机可以操作。
