...
使用雪暴娃娃机的安卓版套装，您可以
<br>
1.通过我们提供的xuebaoPush.apk快速拥有一个完整的支持双路视频RTMP推流并使娃娃机联网的解决方案。配合** <a href="https://github.com/daniulive/SmarterStreaming" target="_blank">大牛直播SDK播放端</a>**，将可以使视频延迟保证在一秒左右。
...
* 如果您选择xuebaoPush.apk，而决定采用自己的管理软件，我们会在稍后放出管理协议。目前由于部分功能仍在开发，因此接口尚不完备.
* 我们还在加紧整理文档和开发新功能和用户使用指引。敬请关注本github的说明及wiki。

2.**本安卓版也支持各种互动直播技术，如腾讯互动直播，阿里连麦，即构，anyRCT的私有视频传输协议。** 如果选择私有视频协议，您也可以购买我们的产品，然后选择不安装xuebaoPush.apk。
...
<img src="http://chuantu.biz/t6/190/1514625756x-1404792895.png" alt="雪暴网络娃娃机安卓结构示意图" />
...
2.使用prebuild中的android-push文件夹中的安装脚本将xuebaoPush.apk安装到安卓板上，这时，如果网线已连接到路由器，则该娃娃机已正常工作。
...
* [**prebuild**] 包含了最新的安卓推流程序, 局域网配置工具 公网配置工具 预生成的安卓简单操作客户端.
	* 安卓版电脑有线部署工具 内含最新推流程序和电脑有线直连安装脚本。
...
* [**SimpleServer**]简单应用服务器java源码。
	...
	* xuebaoPush.apk启动后，会自动注册到配置服务器，外网配置工具可通过配置服务器配置安卓板参数
