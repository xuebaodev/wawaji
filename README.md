...
* 此双路推流程序RTMPPush由大牛直播提供三个月的试用，如果要商用，请向大牛直播申请授权。然后您将自己负责授权版本的代码更新。
...
* [**RTMPPush**] 基于大牛SDK安双路RTMP摄像头推流及娃娃机指令交互安卓板源码。 此源码包含的RTMP双路推流授权有效期仅为3个月。如果决定采用大牛双路推流，请自行联系授权。

* [**prebuild**] 包含了最新的安卓推流程序, 局域网配置工具 公网配置工具 预生成的安卓简单操作客户端.
	* 安卓版电脑有线部署工具 内含编译出来的推流程序和电脑有线直连安装脚本。
